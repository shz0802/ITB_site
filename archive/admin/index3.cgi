...
END
	my $poster_content = EXTRACT_DIV('../index2.html', 'div', 'poster', 'content');
...
sub WRITE_POSTER {
	...
	my $data_poster = EXTRACT_DIV('../index2.html','div','poster','content');
	...
	&WRITE_DIV('..','index2.html','poster',$data_write,$encode);
	print "<li>index.htmlへの書き込みが完了しました。</li>";
}
